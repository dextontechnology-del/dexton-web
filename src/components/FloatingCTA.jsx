  ...
  const ctaButtons = [
    {
      ...
      ariaLabel: "Call Dexton Technology"
    },
    {
    ...
    },
    {
      ...
      label: "Email",
      href: "mailto:dextontechnology@gmail.com?subject=Inquiry%20from%20Website",
      ...
      {isVisible && (
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className={`w-14 h-14 ${isExpanded ? 'bg-neutral-800' : 'bg-primary-600'} text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:shadow-xl`}
